...
//Last modified: Mon, Jan 04, 2021 01:38:42 PM
//Codeset: UTF-8
requires maya "2019";
requires "mtoa" "3.1.2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.72419488226558926 17.025109898366647 30.101714154997353 ;
	setAttr ".r" -type "double3" -23.738352724362993 714.20000000072571 -1.9980754056959355e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F7907335-C144-0C1F-6968-EFBAA6E68AF1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 33.398786635171916;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.0135656275356606 2.5903979291924459 0.015930139788676634 ;
...
createNode imagePlane -n "imagePlaneShape1" -p "imagePlane1";
	...
	setAttr -k off ".v";
	setAttr ".fc" 102;
	setAttr ".imn" -type "string" "/Users/samuel.k407/Desktop/Kodochrome camera/Kodochrome chamera/leicam2pv1.jpg";
...
createNode imagePlane -n "imagePlaneShape2" -p "imagePlane2";
	...
	setAttr -k off ".v";
	setAttr ".fc" 102;
	setAttr ".imn" -type "string" "/Users/samuel.k407/Desktop/Kodochrome camera/Kodochrome chamera/1616px-Leica_M2_img_1835.jpg";
...
createNode transform -n "pCylinder1";
	...
	setAttr ".t" -type "double3" -5.7479325213039711 2.7816380014428121 0.015930676230479612 ;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.51206976175308228 0.84428530931472778 ;
	...
	setAttr -s 19 ".pt";
	setAttr ".pt[84]" -type "float3" 0 0.60783422 0 ;
	setAttr ".pt[85]" -type "float3" -5.941838e-07 0.60783422 -1.4901161e-07 ;
	setAttr ".pt[86]" -type "float3" -5.941838e-07 0.60783422 1.4901161e-07 ;
	setAttr ".pt[87]" -type "float3" -5.941838e-07 0.60783422 5.9604645e-08 ;
	setAttr ".pt[88]" -type "float3" -5.941838e-07 0.60783422 0 ;
	setAttr ".pt[89]" -type "float3" -5.941838e-07 0.60783422 1.0430813e-07 ;
	setAttr ".pt[90]" -type "float3" -5.941838e-07 0.60783422 2.9802322e-08 ;
	setAttr ".pt[91]" -type "float3" -5.941838e-07 0.60783422 -5.9604645e-08 ;
	setAttr ".pt[92]" -type "float3" -5.941838e-07 0.60783422 -7.4505806e-08 ;
	setAttr ".pt[93]" -type "float3" -7.1339309e-07 0.60783422 -5.9604645e-08 ;
	setAttr ".pt[94]" -type "float3" -5.941838e-07 0.60783422 0 ;
	setAttr ".pt[95]" -type "float3" -5.941838e-07 0.60783422 1.4210855e-14 ;
	setAttr ".pt[96]" -type "float3" 0 0.60783422 0 ;
	setAttr ".pt[97]" -type "float3" 0 0.60783422 0 ;
	setAttr ".pt[98]" -type "float3" 0 0.60783422 0 ;
	setAttr ".pt[99]" -type "float3" 0 0.60783422 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C0A65E9C-9549-D9C7-B1B5-72851670A36B";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A8D9811D-5F4F-5CBB-0394-0AB67FF64173";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A5C29CC4-F94A-7B0E-D7FF-279B05589F1C";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "2BB5F997-1945-1D7E-13F9-C39D543DDE17";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "8ACF55CB-5348-A5E7-033B-37A811412C27";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B2E2AA0F-104C-838B-930E-A08ECC99F406";
