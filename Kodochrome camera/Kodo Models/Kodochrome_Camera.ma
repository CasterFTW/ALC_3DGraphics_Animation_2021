...
//Last modified: Fri, Jan 08, 2021 01:37:36 PM
//Codeset: UTF-8
requires maya "2019";
requires "mtoa" "3.1.2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.9751709459782609 8.2051155508155755 0.31838991744196066 ;
	setAttr ".r" -type "double3" 9.8616472640171864 3158.6000000006752 -5.3173962221394325e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F7907335-C144-0C1F-6968-EFBAA6E68AF1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 2.0530208704965562;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 3.9751144647598267 8.5567357122977032 0.015926897525787354 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
	setAttr ".ai_translator" -type "string" "perspective";
createNode transform -s -n "top";
	rename -uid "8A87DA8D-8442-7A84-6699-35BE891BBF5B";
	setAttr ".t" -type "double3" 3.9799203136184085 1000.1010543708301 0.62936005902957337 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "E8BD965D-B34C-DC34-4926-31A75C731E1D";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 991.53332939413406;
	setAttr ".ow" 9.6409291443344323;
	setAttr ".imn" -type "string" "top";
	setAttr ".den" -type "string" "top_depth";
	setAttr ".man" -type "string" "top_mask";
	setAttr ".tp" -type "double3" 3.9751144647598267 8.5677249766957519 0.057055741548538208 ;
...
createNode transform -n "polySurface2" -p "pCylinder1";
	...
	setAttr ".t" -type "double3" 0 3.0960825387871385 0 ;
	setAttr ".s" -type "double3" 1 0.66208419813829045 1 ;
...
createNode mesh -n "polySurfaceShape2" -p "polySurface2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49857896566390991 0 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "543E4B07-D14A-C6D2-58CA-1099E04B289C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "962A31BD-E645-FFE9-9F16-5695FA249B28";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D6223856-914F-D523-CC36-30A2AD826F9C";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "2BB5F997-1945-1D7E-13F9-C39D543DDE17";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "A8279659-F142-35A9-A988-36B404F2D354";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "079A9177-F442-C979-B1FA-B48932F1A2CD";
...
createNode polyTweak -n "polyTweak13";
	...
	setAttr ".uopa" yes;
	setAttr -s 23 ".tk";
	setAttr ".tk[21]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[22]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[23]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[24]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[25]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[26]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[27]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[28]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[29]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[30]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[31]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[32]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[33]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[34]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[35]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[36]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[37]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[38]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[39]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[40]" -type "float3" 0 0.89021498 0 ;
	setAttr ".tk[41]" -type "float3" 0 0.89021498 0 ;
...
connectAttr "polyMergeVert67.out" "polySurfaceShape2.i";
